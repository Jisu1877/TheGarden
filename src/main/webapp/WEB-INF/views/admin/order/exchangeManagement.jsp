	...
	<script>
		...
		function processOk() {
			...
			if(memo == "") {
				...
				alert("교환 승인 시에는 택배사 선택이 필수 사항입니다.");
				return false;
			}
			else if(flag == 'y' && number == "") {
				alert("교환 승인 시에는 수거 송장 번호를 입력하셔야 합니다.");
 	...
 	<div class="w3-row-padding w3-margin-bottom" style="padding-top:22px;">
		<div class="w3-row" style="margin-bottom:10px;">
			...
			<div class="w3-half w3-padding">
				...
				<form name="requestAnsForm" method="post" action="${ctp}/admin/order/exchangeAns">
					<table class="table table-borderless">
							...
							<td>
								<div class="form-check-inline">
						        	<div class="form-check">
									    <input type="radio" name="request_flag" value="y" checked>&nbsp;&nbsp;교환 승인&nbsp;&nbsp;&nbsp;
									    <input type="radio" name="request_flag" value="n">&nbsp;&nbsp;교환 반려
									</div>
								</div>
							</td>
						</tr>
						<tr>
							<th>관리자 메세지</th>
							<td>
								<textarea rows="5" name="exchange_admin_memo" id="exchange_admin_memo" class="form-control"></textarea>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="2" class="text-center">
								<input type="button" value="처리 완료" onclick="processOk()" class="btn w3-2020-orange-peel btn-sm"/>
							</td>
						</tr>
					</table>
