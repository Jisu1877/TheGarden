		    		...
		    		<form name="answerForm" method="post">
			    		<div>
			    			<div class="mb-3">
			    				...
			    				<a href="javascript:answerInsert()" class="w3-button w3-black w3-hover-black w3-round-large w3-padding-small w3-small w3-right">답변 수정</a>
			    			</div>
						   <textarea rows="10" id="CKEDITOR" name="admin_content" class="form-control">${vo.admin_content}</textarea> 				
			    		</div>
