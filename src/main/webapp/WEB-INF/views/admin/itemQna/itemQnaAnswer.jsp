 	...
 	<div class="w3-row-padding w3-margin-bottom">
		...
		<header style="padding-top:22px;">
			<div class="w3-bottombar w3-light-gray w3-padding" style="margin-bottom: 20px;">
		    	<span style="font-size:23px;">상품 문의 답변 등록</span>
						...
						<table class="w3-table" style="border-collapse:separate;">
							...
							<tbody>
								<tr>
									<td>
										<br>
										<textarea rows="12" class="form-control" placeholder="답변내용을 입력하세요." name="admin_answer" id="admin_answer"></textarea>
									</td>
								</tr>
								<tr>
									<td class="text-center">
										<a href="javascript:adminAnswer()" class="w3-btn w3-2021-inkwell w3-padding-small w3-round-large m-2">답변 등록</a>
									</td>
								</tr>
							</tbody>
						</table>
