 	...
 	<div class="w3-row-padding w3-margin-bottom">
		...
		<header style="padding-top:22px;">
			<div class="w3-bottombar w3-light-gray w3-padding" style="margin-bottom: 20px;">
		    	<span style="font-size:23px;">공지 수정</span>
		    			...
		    			<div class="mb-3">
		    				...
		    				<div class="form-check-inline">
					        	<div class="form-check">
								    <input type="radio" name="popup_yn" value="y" ${vo.popup_yn == 'y' ? 'checked' : '' }>&nbsp;&nbsp;팝업 사용&nbsp;&nbsp;&nbsp;
								    <input type="radio" name="popup_yn" value="n" ${vo.popup_yn == 'n' ? 'checked' : '' }>&nbsp;&nbsp;팝업 미사용
								</div>
							</div>
		    			</div>
		    			<div class="mb-3">
							...
							<c:if test="${vo.popup_yn == 'y'}">
								...
								<div>
									<i class="fa-solid fa-circle-info"></i> 이미지 파일을 새롭게 첨부시 기존 이미지 파일은 삭제됩니다.
								</div>
							</c:if>
		    			</div>
		    			<div class="mb-3">
		    				<span style="font-size:19px;">공지 제목</span>
		    				<input type="text" class="w3-input w3-border" value="${vo.notice_title}" id="notice_title" name="notice_title"/>
		    			</div>
		    			<div class="mb-3">
		    				<span style="font-size:19px;">공지 내용</span>
		    			</div>
					   <textarea rows="10" id="CKEDITOR" name="notice_content" class="form-control">${vo.notice_content}</textarea> 				
		    		</div>
		    		<div class="text-center mt-4">
		    			<a href="javascript:noticeInsert()" class="w3-btn w3-2020-ultramarine-green w3-round-large">공지 수정</a>
		    		</div>
