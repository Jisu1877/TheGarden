...
<head>
    ...
    <script>
    	function orderCancelRequest(ilstIdx,price,point,orderIdx,coupon) {
	...
	<div style="margin-top:10px; padding:10px;">
		<div class="w3-row-padding w3-padding-16">
			...
			<div class="w3-col m10 w3-margin-bottom">
				<div class="mb-2">
					<i class="fa-solid fa-circle-info"></i> 주문 확인이 진행된 상품은 즉시 취소가 불가능합니다.<br> 취소 요청이 반려될 수 있음을 알려드립니다.
				</div>
				<div>
				...
				<div class="text-center">
					<a class="w3-btn w3-2021-mint" onclick="orderCancelRequest(${vo.order_list_idx},${refund},${vo.use_point},${vo.order_idx},${vo.coupon_amount})">취소 요청</a>&nbsp;
